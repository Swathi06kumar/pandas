...
Original file is located at
    https://colab.research.google.com/drive/153vNfz-Fqc0TutGGtJ2M9o0C1xHdHkWp
...
index_X = (df['X'] == 0).idxmax()
df['Y'].iloc[0:index_X] += 1
df
...
x,y = df.FlightNumber.loc[[0]].values[0]+10, df.FlightNumber.loc[[4]].values[0]-10
...
import matplotlib.pyplot as plt
df.plot.scatter("productivity","hours_in","happiness","caffienated",marker='*')
...
import matplotlib.pyplot as plt
df.plot.bar('month','revenue',color='g')

df.plot('advertising',"month",marker='*')
plt.grid
